sap.ui.define([
	...
	return UI5Object.extend("be.wl.zcomploaderlib.controllers.ErrorHandler", {
		 ...
		 * @public
		 * @alias be.elia.hr.trvexp.create.controller.ErrorHandler
		 */
		...
		_showServiceError: function (sDetails) {
			...
			if(responseText && responseText.error && responseText.error.message && responseText.error.message.value){
				detail = responseText.error.message.value;
			}
